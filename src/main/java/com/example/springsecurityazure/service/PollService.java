...
import com.example.springsecurityazure.payload.request.PollRequest;
import com.example.springsecurityazure.payload.request.VoteRequest;
import com.example.springsecurityazure.payload.response.PagedResponse;
import com.example.springsecurityazure.payload.response.PollResponse;
...
public class PollService {
    ...
    public PagedResponse<PollResponse> getPollsCreatedBy(String name, UserPrincipal currentUser, int page, int size) {
        validatePageNumberAndSize(page, size);
    ...
    public PagedResponse<PollResponse> getPollsVotedBy(String name, UserPrincipal currentUser, int page, int size) {
        validatePageNumberAndSize(page, size);
